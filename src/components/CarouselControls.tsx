...
export function CarouselControls({page, pages, onChange, hrefs, indicator = 'segments', arrows = true, labels}: CarouselControlsProps) {
  if (pages <= 1) return null;
  if (hrefs) return <LinkControls page={page} pages={pages} hrefs={hrefs} indicator={indicator} arrows={arrows} labels={labels} />;
