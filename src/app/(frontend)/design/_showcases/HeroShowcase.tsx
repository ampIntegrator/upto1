  ...
  return (
    <VStack gap={8}>
      <Text type="body" color="secondary">
        Le haut de page, un seul composant, cinq modèles (les mêmes noms que dans l'admin) : plein écran image ou vidéo (maquette 16), plein écran texte et image (maquette 02), haut de page image, clair ou nuit (maquette 25 A, B, C). Chaque page de démonstration du menu en montre une en situation, sous l'en-tête. Ici, sans réserve d'en-tête et à hauteur réduite pour le catalogue.
      </Text>
      <VStack gap={3}>
        <Heading level={3}>Haut de page · image (maquette 25 A)</Heading>
      ...
      <VStack gap={3}>
        <Heading level={3}>Haut de page · clair (maquette 25 B)</Heading>
      ...
      <VStack gap={3}>
        <Heading level={3}>Haut de page · nuit (maquette 25 C)</Heading>
      ...
      <VStack gap={3}>
        <Heading level={3}>Plein écran · texte et image (maquette 02)</Heading>
      ...
      <VStack gap={3}>
        <Heading level={3}>Plein écran · image ou vidéo (maquette 16)</Heading>
