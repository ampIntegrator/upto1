  ...
  return (
    <VStack gap={8}>
      <Text type="body" color="secondary">
        Liste à pastilles rondes de 18 px : coche blanche sur silo, ou croix blanche sur danger pour la colonne « avant ». Compacte et alignée en haut dans les étapes ; en rangées à filets, alignée au centre, dans les cartes comparatives. Le ton se règle pour la liste entière ou item par item.
      </Text>
      <VStack gap={3}>
      ...
      <VStack gap={3}>
        ...
        <Grid columns={12} gap={6} className="page-grid">
          <GridSpan columns={6}><CheckList items={AVANT} tone="cross" divided /></GridSpan>
          <GridSpan columns={6}><CheckList items={APRES} divided /></GridSpan>
        </Grid>
      </VStack>
      <VStack gap={3}>
