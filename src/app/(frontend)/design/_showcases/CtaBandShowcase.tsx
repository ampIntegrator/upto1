  ...
  return (
    <VStack gap={6}>
      ...
      <VStack gap={6} style={{maxWidth: 760}}>
        <CtaBand iconKey="calculator" title="Estimez votre gain de temps" text="Quelques chiffres suffisent pour projeter l’impact sur votre cycle commercial." button={{label: 'Lancer le calcul', href: '#', variant: 'high'}} />
        <CtaBand variant="arrow" title="Lire le guide du chiffrage en visite" button={{label: 'En savoir plus', href: '#', variant: 'high'}} />
      </VStack>
    </VStack>
  );
}
