...
const SAMPLES: ContentRef[] = [
  ...
  {type: 'sectionHeading'}, {type: 'sectionNote'}, {type: 'tabs', count: 4}, {type: 'tabs', count: 6}, {type: 'tabs', count: 8}, {type: 'collapsibleGroup'}, {type: 'testimonialCarousel'}, {type: 'mediaQuote'},
