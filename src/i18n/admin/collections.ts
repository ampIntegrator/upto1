...
export const collectionsText = texts({
  ...
  caseStudies: {
    ...
    fields: {
      ...
      coverCaption: {fr: 'Légende de l’image (en bas à droite de l’image)', en: 'Image caption (bottom right of the image)'},
      coverCaptionTone: {fr: 'Couleur de la légende', en: 'Caption colour'},
      coverOverlay: {fr: 'Calque sur l’image (0 à 1)', en: 'Overlay on the image (0 to 1)'},
      coverOverlayDescription: {fr: 'Opacité du calque posé entre l’image et le titre : 0, aucun calque. Pour qu’une image claire garde le titre et le chapô lisibles.', en: 'Opacity of the layer between the image and the title: 0, no layer. Keeps the title and lead readable on a light image.'},
      coverOverlayColor: {fr: 'Couleur du calque', en: 'Overlay colour'},
      overlayBlack: {fr: 'Noir', en: 'Black'},
      overlaySilo: {fr: 'Couleur du silo', en: 'Silo colour'},
      captionLight: {fr: 'Blanc', en: 'White'},
      captionDark: {fr: 'Noir', en: 'Black'},
