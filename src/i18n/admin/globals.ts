...
export const settingsText = texts({
  ...
  blog: {
    ...
    notice: {fr: 'Cette page est la page du blog (Réglages du site › Blog) : son haut de page et ses sections ne sont pas affichés, le site montre la liste des articles.', en: 'This page is the blog page (Site settings › Blog): its page top and sections are not displayed, the site shows the list of posts.'},
  },
  sectionGrid: {
