...
export const formsText = texts({
  ...
  heading: {fr: 'Titre affiché (facultatif)', en: 'Displayed title (optional)'},
  headingDescription: {fr: 'Au-dessus des champs. Un mot entre <span>…</span> passe en serif accentué. Le « Titre » plus haut ne sert qu’à retrouver le formulaire dans l’admin.', en: 'Above the fields. A word between <span>…</span> is set in accent serif. The « Title » above only names the form in the admin.'},
  intro: {fr: 'Texte d’introduction (facultatif)', en: 'Intro text (optional)'},
