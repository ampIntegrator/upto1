...
export const orbitaVioletTheme = {
  ...
  tokens: {
    ...
    "--color-highlight": "light-dark(#C77DFF, #C77DFF)",
    "--color-highlight-deep": "light-dark(#9D4EDD, #C77DFF)",
    "--color-highlight-muted": "light-dark(color-mix(in srgb, #C77DFF 14%, transparent), color-mix(in srgb, #C77DFF 22%, transparent))",
