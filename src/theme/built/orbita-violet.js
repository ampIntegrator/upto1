...
/**
 * orbita-violet theme — built by `pnpm exec astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { orbitaVioletTheme } from './orbita-violet';
 *   import './orbita-violet.css';
 */
export const orbitaVioletTheme = {
  name: 'orbita-violet',
  __built: true,
  tokens: {
    "--color-accent": "light-dark(#8B47BE, #8B47BE)",
    ...
    "--color-neutral": "light-dark(#1E1A201A, #E6E0E933)",
    "--color-background-surface": "light-dark(#FFFFFF, color-mix(in srgb, #241038 82%, #000000))",
    "--color-background-body": "light-dark(#F7F3FB, #241038)",
    "--color-overlay": "light-dark(color-mix(in srgb, #8B47BE 26%, rgba(28,38,68,.4)), color-mix(in srgb, #241038 58%, rgba(7,9,26,.6)))",
    "--color-overlay-hover": "light-dark(#1E1A200D, #FFFFFF0D)",
    "--color-overlay-pressed": "light-dark(#1E1A201A, #FFFFFF1A)",
    "--color-background-muted": "light-dark(#EDE4F5, rgba(255,255,255,.06))",
    ...
    "--color-text-accent": "light-dark(#8B47BE, #B082D3)",
    "--color-icon-accent": "light-dark(#8B47BE, #B082D3)",
    ...
    "--color-background-card": "light-dark(#FFFFFF, color-mix(in srgb, #241038 82%, #000000))",
    "--color-background-popover": "light-dark(#FFFFFF, color-mix(in srgb, #241038 88%, #FFFFFF))",
    "--color-background-inverted": "light-dark(#241038, #FFFFFF)",
    ...
    "--color-highlight": "light-dark(#A3E635, #A3E635)",
    "--color-highlight-deep": "light-dark(#5C9A0A, #A3E635)",
    "--color-highlight-muted": "light-dark(color-mix(in srgb, #A3E635 14%, transparent), color-mix(in srgb, #A3E635 22%, transparent))",
    ...
    "--color-background-light": "light-dark(#F7F3FB, rgba(255,255,255,.03))",
