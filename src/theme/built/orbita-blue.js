...
/**
 * orbita-blue theme — built by `pnpm exec astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { orbitaBlueTheme } from './orbita-blue';
 *   import './orbita-blue.css';
 */
export const orbitaBlueTheme = {
  name: 'orbita-blue',
  __built: true,
  tokens: {
    "--color-accent": "light-dark(#4F46E5, #4F46E5)",
    ...
    "--color-neutral": "light-dark(#1C1B211A, #E4E1EA33)",
    "--color-background-surface": "light-dark(#FFFFFF, color-mix(in srgb, #1B1A4E 82%, #000000))",
    "--color-background-body": "light-dark(#F4F6FB, #1B1A4E)",
    "--color-overlay": "light-dark(color-mix(in srgb, #4F46E5 26%, rgba(28,38,68,.4)), color-mix(in srgb, #1B1A4E 58%, rgba(7,9,26,.6)))",
    "--color-overlay-hover": "light-dark(#1C1B210D, #FFFFFF0D)",
    "--color-overlay-pressed": "light-dark(#1C1B211A, #FFFFFF1A)",
    "--color-background-muted": "light-dark(#E8ECF6, rgba(255,255,255,.06))",
    ...
    "--color-text-accent": "light-dark(#4F46E5, #8781ED)",
    "--color-icon-accent": "light-dark(#4F46E5, #8781ED)",
    ...
    "--color-background-card": "light-dark(#FFFFFF, color-mix(in srgb, #1B1A4E 82%, #000000))",
    "--color-background-popover": "light-dark(#FFFFFF, color-mix(in srgb, #1B1A4E 88%, #FFFFFF))",
    "--color-background-inverted": "light-dark(#1B1A4E, #FFFFFF)",
    ...
    "--color-highlight": "light-dark(#10E0C8, #10E0C8)",
    "--color-highlight-deep": "light-dark(#0A9E8E, #10E0C8)",
    "--color-highlight-muted": "light-dark(color-mix(in srgb, #10E0C8 14%, transparent), color-mix(in srgb, #10E0C8 22%, transparent))",
    ...
    "--color-night-deep": "light-dark(color-mix(in srgb, #1B1A4E 68%, #000000), color-mix(in srgb, #1B1A4E 68%, #000000))",
    "--color-night-deeper": "light-dark(color-mix(in srgb, #1B1A4E 40%, #000000), color-mix(in srgb, #1B1A4E 40%, #000000))",
    "--color-background-light": "light-dark(color-mix(in srgb, #4F46E5 5%, transparent), rgba(255,255,255,.03))",
    "--color-highlight-light": "light-dark(color-mix(in srgb, #10E0C8 5%, transparent), color-mix(in srgb, #10E0C8 5%, transparent))",
