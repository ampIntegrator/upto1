...
export const orbitaOrangeTheme = {
  ...
  tokens: {
    ...
    "--color-highlight": "light-dark(#F5C403, #F5C403)",
    "--color-highlight-deep": "light-dark(#C99700, #F5C403)",
    "--color-highlight-muted": "light-dark(color-mix(in srgb, #F5C403 14%, transparent), color-mix(in srgb, #F5C403 22%, transparent))",
