...
/**
 * orbita-magenta theme — built by `pnpm exec astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { orbitaMagentaTheme } from './orbita-magenta';
 *   import './orbita-magenta.css';
 */
export const orbitaMagentaTheme = {
  name: 'orbita-magenta',
  __built: true,
  tokens: {
    "--color-accent": "light-dark(#C42E86, #C42E86)",
    ...
    "--color-neutral": "light-dark(#21191D1A, #EBDFE433)",
    "--color-background-surface": "light-dark(#FFFFFF, color-mix(in srgb, #2A0E22 82%, #000000))",
    "--color-background-body": "light-dark(#FBF1F7, #2A0E22)",
    "--color-overlay": "light-dark(color-mix(in srgb, #C42E86 26%, rgba(28,38,68,.4)), color-mix(in srgb, #2A0E22 58%, rgba(7,9,26,.6)))",
    "--color-overlay-hover": "light-dark(#21191D0D, #FFFFFF0D)",
    "--color-overlay-pressed": "light-dark(#21191D1A, #FFFFFF1A)",
    "--color-background-muted": "light-dark(#F4DCEC, rgba(255,255,255,.06))",
    ...
    "--color-text-accent": "light-dark(#C42E86, #D771AD)",
    "--color-icon-accent": "light-dark(#C42E86, #D771AD)",
    ...
    "--color-background-card": "light-dark(#FFFFFF, color-mix(in srgb, #2A0E22 82%, #000000))",
    "--color-background-popover": "light-dark(#FFFFFF, color-mix(in srgb, #2A0E22 88%, #FFFFFF))",
    "--color-background-inverted": "light-dark(#2A0E22, #FFFFFF)",
    ...
    "--color-highlight-muted": "light-dark(color-mix(in srgb, #4ADE9B 14%, transparent), color-mix(in srgb, #4ADE9B 22%, transparent))",
    ...
    "--color-night-deep": "light-dark(color-mix(in srgb, #2A0E22 68%, #000000), color-mix(in srgb, #2A0E22 68%, #000000))",
    "--color-night-deeper": "light-dark(color-mix(in srgb, #2A0E22 40%, #000000), color-mix(in srgb, #2A0E22 40%, #000000))",
    "--color-background-light": "light-dark(color-mix(in srgb, #C42E86 5%, transparent), rgba(255,255,255,.03))",
    "--color-highlight-light": "light-dark(color-mix(in srgb, #4ADE9B 5%, transparent), color-mix(in srgb, #4ADE9B 5%, transparent))",
