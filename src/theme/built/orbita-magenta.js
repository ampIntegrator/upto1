...
export const orbitaMagentaTheme = {
  ...
  tokens: {
    ...
    "--color-highlight": "light-dark(#FF7AC4, #FF7AC4)",
    "--color-highlight-deep": "light-dark(#C42E86, #FF7AC4)",
    "--color-highlight-muted": "light-dark(color-mix(in srgb, #FF7AC4 14%, transparent), color-mix(in srgb, #FF7AC4 22%, transparent))",
