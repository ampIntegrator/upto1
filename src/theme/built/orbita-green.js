...
/**
 * orbita-green theme — built by `pnpm exec astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { orbitaGreenTheme } from './orbita-green';
 *   import './orbita-green.css';
 */
export const orbitaGreenTheme = {
  name: 'orbita-green',
  __built: true,
  tokens: {
    "--color-accent": "light-dark(#40916C, #40916C)",
    ...
    "--color-background-surface": "light-dark(#FFFFFF, color-mix(in srgb, #0E2C2E 82%, #000000))",
    "--color-background-body": "light-dark(#F1F6F2, #0E2C2E)",
    "--color-overlay": "light-dark(color-mix(in srgb, #40916C 26%, rgba(28,38,68,.4)), color-mix(in srgb, #0E2C2E 58%, rgba(7,9,26,.6)))",
    "--color-overlay-hover": "light-dark(#151D190D, #FFFFFF0D)",
    "--color-overlay-pressed": "light-dark(#151D191A, #FFFFFF1A)",
    "--color-background-muted": "light-dark(#E4EFE7, rgba(255,255,255,.06))",
    ...
    "--color-text-accent": "light-dark(#40916C, #7DB49B)",
    "--color-icon-accent": "light-dark(#40916C, #7DB49B)",
    ...
    "--color-background-card": "light-dark(#FFFFFF, color-mix(in srgb, #0E2C2E 82%, #000000))",
    "--color-background-popover": "light-dark(#FFFFFF, color-mix(in srgb, #0E2C2E 88%, #FFFFFF))",
    "--color-background-inverted": "light-dark(#0E2C2E, #FFFFFF)",
    ...
    "--color-highlight": "light-dark(#F5B841, #F5B841)",
    "--color-highlight-deep": "light-dark(#B8800A, #F5B841)",
    "--color-highlight-muted": "light-dark(color-mix(in srgb, #F5B841 14%, transparent), color-mix(in srgb, #F5B841 22%, transparent))",
    "--color-editorial": "light-dark(#C7972E, #C7972E)",
    "--color-editorial-deep": "light-dark(#A37B1F, #C7972E)",
    "--color-night": "light-dark(#0E2C2E, #0E2C2E)",
    "--color-night-deep": "light-dark(color-mix(in srgb, #0E2C2E 68%, #000000), color-mix(in srgb, #0E2C2E 68%, #000000))",
    "--color-night-deeper": "light-dark(color-mix(in srgb, #0E2C2E 40%, #000000), color-mix(in srgb, #0E2C2E 40%, #000000))",
    "--color-background-light": "light-dark(color-mix(in srgb, #40916C 5%, transparent), rgba(255,255,255,.03))",
    "--color-highlight-light": "light-dark(color-mix(in srgb, #F5B841 5%, transparent), color-mix(in srgb, #F5B841 5%, transparent))",
    "--color-accent-deep": "light-dark(#2F6E51, #40916C)"
  },
  components: {
    "heading": {
      "level:1": {
