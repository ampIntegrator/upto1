...
export const orbitaGreenTheme = {
  ...
  tokens: {
    ...
    "--color-highlight": "light-dark(#90D150, #90D150)",
    "--color-highlight-deep": "light-dark(#5AA81F, #90D150)",
    "--color-highlight-muted": "light-dark(color-mix(in srgb, #90D150 14%, transparent), color-mix(in srgb, #90D150 22%, transparent))",
