...
/**
 * orbita-brique theme — built by `pnpm exec astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { orbitaBriqueTheme } from './orbita-brique';
 *   import './orbita-brique.css';
 */
export const orbitaBriqueTheme = {
  name: 'orbita-brique',
  __built: true,
  tokens: {
    "--color-accent": "light-dark(#C2362F, #C2362F)",
    ...
    "--color-neutral": "light-dark(#2219181A, #EDE0DD33)",
    "--color-background-surface": "light-dark(#FFFFFF, color-mix(in srgb, #2A1012 82%, #000000))",
    "--color-background-body": "light-dark(#FBF2F1, #2A1012)",
    "--color-overlay": "light-dark(color-mix(in srgb, #C2362F 26%, rgba(28,38,68,.4)), color-mix(in srgb, #2A1012 58%, rgba(7,9,26,.6)))",
    "--color-overlay-hover": "light-dark(#2219180D, #FFFFFF0D)",
    "--color-overlay-pressed": "light-dark(#2219181A, #FFFFFF1A)",
    "--color-background-muted": "light-dark(#F4DFDC, rgba(255,255,255,.06))",
    ...
    "--color-text-accent": "light-dark(#C2362F, #D67672)",
    "--color-icon-accent": "light-dark(#C2362F, #D67672)",
    ...
    "--color-background-card": "light-dark(#FFFFFF, color-mix(in srgb, #2A1012 82%, #000000))",
    "--color-background-popover": "light-dark(#FFFFFF, color-mix(in srgb, #2A1012 88%, #FFFFFF))",
    "--color-background-inverted": "light-dark(#2A1012, #FFFFFF)",
    ...
    "--color-highlight": "light-dark(#2ED3C3, #2ED3C3)",
    "--color-highlight-deep": "light-dark(#0E9C8F, #2ED3C3)",
    "--color-highlight-muted": "light-dark(color-mix(in srgb, #2ED3C3 14%, transparent), color-mix(in srgb, #2ED3C3 22%, transparent))",
    ...
    "--color-night-deep": "light-dark(color-mix(in srgb, #2A1012 68%, #000000), color-mix(in srgb, #2A1012 68%, #000000))",
    "--color-night-deeper": "light-dark(color-mix(in srgb, #2A1012 40%, #000000), color-mix(in srgb, #2A1012 40%, #000000))",
    "--color-background-light": "light-dark(color-mix(in srgb, #C2362F 5%, transparent), rgba(255,255,255,.03))",
    "--color-highlight-light": "light-dark(color-mix(in srgb, #2ED3C3 5%, transparent), color-mix(in srgb, #2ED3C3 5%, transparent))",
