...
export const orbitaBriqueTheme = {
  ...
  tokens: {
    ...
    "--color-highlight": "light-dark(#FF8A5B, #FF8A5B)",
    "--color-highlight-deep": "light-dark(#C24A22, #FF8A5B)",
    "--color-highlight-muted": "light-dark(color-mix(in srgb, #FF8A5B 14%, transparent), color-mix(in srgb, #FF8A5B 22%, transparent))",
