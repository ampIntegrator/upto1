...
export const orbitaAmbreTheme = {
  ...
  tokens: {
    ...
    "--color-highlight": "light-dark(#F5CE5B, #F5CE5B)",
    "--color-highlight-deep": "light-dark(#B5810F, #F5CE5B)",
    "--color-highlight-muted": "light-dark(color-mix(in srgb, #F5CE5B 14%, transparent), color-mix(in srgb, #F5CE5B 22%, transparent))",
