...
const OWN = new Set(['Media', 'MediaQuote', 'Stat', 'SiteHeader', 'SiteFooter', 'Hero', 'SectionHeading', 'SectionNote', 'CheckList', 'ProcessSteps', 'CompareCard', 'TestimonialCarousel', 'TestimonialCard', 'PriceList', 'PlanCard', 'Callout', 'CardGrid']);
