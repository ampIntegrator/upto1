...
const CATS = {
  ...
  conteneurs:   {label:'Conteneurs', lead:"Cartes et surfaces qui regroupent du contenu.", comps:['Card','CardGrid','Collection','CompareCard','Carousel','TestimonialCarousel','TestimonialCard','ClickableCard','Collapsible','CollapsibleGroup','SelectableCard']},
  contenu:      {label:'Contenu', lead:"Texte, titres, médias et éléments éditoriaux.", comps:['Stat','PriceList','PlanCard','Media','MediaQuote','Avatar','AvatarGroup','AvatarGroupOverflow','AvatarStatusDot','Blockquote','Citation','Code','CodeBlock','EmptyState','Heading','Icon','Kbd','Markdown','Text','Thumbnail','Timestamp','Token']},
