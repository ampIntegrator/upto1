...
const CATS = {
  ...
  contenu:      {label:'Contenu', lead:"Texte, titres, médias et éléments éditoriaux.", comps:['Stat','PriceList','Media','Avatar','AvatarGroup','AvatarGroupOverflow','AvatarStatusDot','Blockquote','Citation','Code','CodeBlock','EmptyState','Heading','Icon','Kbd','Markdown','Text','Thumbnail','Timestamp','Token']},
...
const OWN = new Set(['Media', 'Stat', 'SiteHeader', 'SiteFooter', 'Hero', 'SectionHeading', 'SectionNote', 'CheckList', 'ProcessSteps', 'CompareCard', 'TestimonialCarousel', 'TestimonialCard', 'PriceList', 'Callout', 'CardGrid']);
/** Composants habillés par le thème (démo maison à la place de celle d'origine). */
const DRESSED = new Set(['Media', 'Button', 'Dialog', 'Select', 'TextInput', 'TextArea', 'RadioList', 'CheckboxInput', 'Switch', 'Slider', 'FileInput', 'DateInput', 'DateTimeInput', 'TimeInput', 'DateRangeInput', 'FormLayout', 'InputGroup', 'NumberInput', 'PowerSearch', 'Card', 'ClickableCard', 'Badge', 'Collapsible', 'CollapsibleGroup', 'Tab', 'TabList', 'TabMenu', 'Section', 'Stat', 'SiteHeader', 'TopNav', 'TopNavHeading', 'TopNavItem', 'TopNavMenu', 'TopNavMegaMenu', 'TopNavMegaMenuItem', 'TopNavMegaMenuFeaturedCard', 'MobileNav', 'Breadcrumbs', 'BreadcrumbItem', 'Hero', 'SiteFooter', 'SectionHeading', 'SectionNote', 'CheckList', 'ProcessSteps', 'CompareCard', 'TestimonialCarousel', 'TestimonialCard', 'PriceList', 'Callout', 'CardGrid']);
