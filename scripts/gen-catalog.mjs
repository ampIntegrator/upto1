...
const CATS = {
  ...
  'mise-en-page': {label:'Mise en page', lead:"Coquille d'application, grilles, piles et sections.", comps:['Hero','SectionHeading','PostHeader','PostToc','PostLayout','PostArchive','RelatedPosts','ProcessSteps','SectionNote','AppShell','AspectRatio','Center','Divider','Grid','GridSpan','HStack','Layout','LayoutContent','LayoutFooter','LayoutHeader','LayoutPanel','Resizable','Section','StackItem','VStack']},
