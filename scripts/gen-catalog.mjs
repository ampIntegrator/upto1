...
const CATS = {
  ...
  contenu:      {label:'Contenu', lead:"Texte, titres, médias et éléments éditoriaux.", comps:['TextBox','RichText','KeyPoints','CtaBand','StatsBand','QuoteCard','Gallery','Stat','PriceList','PlanCard','Media','MediaQuote','Avatar','AvatarGroup','AvatarGroupOverflow','AvatarStatusDot','Blockquote','Citation','Code','CodeBlock','EmptyState','Heading','Icon','Kbd','Markdown','Text','Thumbnail','Timestamp','Token']},
  ...
  formulaires:  {label:'Formulaires', lead:"Champs, sélecteurs et contrôles de saisie.", comps:['SiteForm','Calendar','CheckboxInput','CheckboxList','CheckboxListItem','DateInput','DateRangeInput','DateTimeInput','Field','FieldLabel','FieldStatus','FileInput','FormLayout','InputGroup','NumberInput','PowerSearch','RadioList','RadioListItem','Select','Slider','Switch','TextArea','TextInput','TimeInput']},
  'mise-en-page': {label:'Mise en page', lead:"Coquille d'application, grilles, piles et sections.", comps:['Hero','SectionHeading','PostHeader','PostToc','PostLayout','PostArchive','EntryFaq','RelatedPosts','CaseHero','CaseSheet','ProcessSteps','SectionNote','AppShell','AspectRatio','Center','Divider','Grid','GridSpan','HStack','Layout','LayoutContent','LayoutFooter','LayoutHeader','LayoutPanel','Resizable','Section','StackItem','VStack']},
...
const OWN = new Set(['Media', 'MediaQuote', 'Stat', 'SiteHeader', 'SiteFooter', 'Hero', 'SectionHeading', 'SectionNote', 'CheckList', 'ProcessSteps', 'CompareCard', 'TestimonialCarousel', 'TestimonialCard', 'PriceList', 'PlanCard', 'Collection', 'TextBox', 'RichText', 'Tabs', 'ButtonGroup', 'KeyPoints', 'CtaBand', 'StatsBand', 'QuoteCard', 'Gallery', 'PostHeader', 'PostToc', 'PostLayout', 'PostArchive', 'EntryFaq', 'RelatedPosts', 'CaseHero', 'CaseSheet', 'Callout', 'CardGrid', 'SiteForm']);
